 <?php
    // WC() not $GLOBALS['woocommerce']
    // var_dump($GLOBALS);
    $args = array(
        'status'   => 'publish',
        'category' => array('wraps'),
 ...
 <div class="shop-content-first-element page-<?= $post->ID  ?>">
     ...
     <?php if ($counter < 1) : ?>
         <div class="shop-title-without-cart">
             <h5>Sorry, no products left in stock.</h5>
     ...
     <?php else : ?>
         <h5 class="shop-title-with-cart">
             ...
             <span><?php echo $counter; ?> available <?php echo ($counter > 1 ? "products" : "product") ?> today.</span>
         </h5>
 ...
 <?php #do_action('get-custom-products', 10);
    ?>
 </div>
 <!-- end shop-content -->
